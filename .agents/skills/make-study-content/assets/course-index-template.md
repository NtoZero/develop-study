---
title: "{{TOPIC_TITLE}} 학습 로드맵"
description: "{{과정의 범위와 최종 학습 결과}}"
domain: "{{DOMAIN}}"
topic: "{{TOPIC}}"
...
{{이 과정이 다루는 OSS core, extension, cloud·enterprise edition과 대상 버전을 짧게 구분하고 상세 철학·라이선스·거버넌스는 첫 overview 장으로 연결한다.}}
